...
export default function ContactPage() {
    ...
    const socials = [
        ...
        { name: "GitHub", icon: Github, href: "https://github.com/voidcraftr", color: "hover:text-[#333] dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/10" },
    ...
    return (
        <div className="relative min-h-screen w-full overflow-hidden bg-background">
            ...
            <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,oklch(var(--border)/0.3)_1px,transparent_1px),linear-gradient(to_bottom,oklch(var(--border)/0.3)_1px,transparent_1px)] bg-[size:32px_32px]"></div>
            ...
            <div className="mx-auto max-w-6xl py-20 lg:py-32 px-6">
                <div className="grid gap-16 lg:grid-cols-2 items-center">
                    ...
                    >
                        <div className="space-y-6">
                            ...
                            <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-foreground leading-[0.9]">
                                Let's build the <br />
                                <span className="text-primary/90 italic">future together.</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap gap-4">
                                {socials.map((social) => (
                                    <motion.a
                                        ...
                                        whileHover={{ y: -5 }}
                                        whileTap={{ scale: 0.95 }}
                                        className={`flex items-center gap-3 px-6 py-3 rounded-2xl border border-border bg-card hover:shadow-md transition-all ${social.color} font-bold text-sm text-muted-foreground`}
                                    >
                    ...
                    >
                        ...
                        <div className="absolute -inset-4 bg-gradient-to-br from-primary/10 via-blue-500/10 to-emerald-500/10 rounded-[3rem] blur-3xl opacity-50" />

                        <Card className="relative overflow-hidden bg-card border border-border shadow-xl rounded-[3rem] group">
                            <CardContent className="p-10 md:p-14 flex flex-col items-center text-center space-y-10">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative flex h-24 w-24 items-center justify-center rounded-[2rem] bg-background border border-border shadow-lg transition-all group-hover:-translate-y-2 group-hover:border-primary/50">
                                ...
                                <div className="w-full space-y-4">
                                    <div className="relative group/input w-full">
                                        <div className="relative flex w-full items-center gap-3 rounded-2xl border border-input bg-background/50 p-3 pl-6 shadow-sm">
                                            <span className="flex-1 text-left font-mono text-sm font-bold text-foreground truncate">
                                                {email}
                                            </span>
                                            <Button
                                                onClick={copyEmail}
                                    ...
                                    <a href={`mailto:${email}`} className="block w-full">
                                        <Button size="lg" variant="outline" className="w-full h-16 rounded-2xl font-black uppercase tracking-widest text-xs transition-all hover:scale-[1.02] active:scale-[0.98] border-border hover:bg-muted/50">
                                            Open System Mailer
                                        </Button>
                                    </a>
                                </div>
