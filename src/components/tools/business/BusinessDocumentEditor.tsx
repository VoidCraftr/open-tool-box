    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            const canvas = await html2canvas(docRef.current, {
                scale: 1.5, // Balanced scale for good quality and reasonable file size
                useCORS: true,
            ...
            // Use JPEG for light themes (better compression), PNG for dark themes (preserves quality)
            const useJPEG = theme === "professional" || theme === "minimal"
            const imgData = useJPEG
                ? canvas.toDataURL("image/jpeg", 0.95) // 95% quality JPEG = excellent quality, moderate size
            ...
            pdf.addImage(
                ...
                canvas.height / 1.5,
                undefined,
                useJPEG ? "FAST" : "NONE" // Fast compression for JPEG
            )
            ...
            <div className="space-y-8 sticky top-24">
                ...
                <div className="relative group">
                    ...
                    >
                        ...
                        {/* Footer Watermark */}
                        <div className="mt-16 pt-8 flex justify-center text-center" style={{ ...currentTheme.border, borderTopWidth: '1px', borderStyle: 'solid', opacity: 0.4 }}>
                            <p className="font-bold uppercase tracking-widest" style={{ fontSize: '10px', ...currentTheme.muted }}>
                                PDF generated by <span style={currentTheme.header}>opentoolbox.online</span>
                            </p>
                        </div>
